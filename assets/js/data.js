  ...
  posts: [
    {
      ...
      toc: [
        ...
        { id: "immediate-steps", text: "3. Immediate Steps: What To Do First" },
        { id: "rebuilding-right", text: "4. Rebuilding It Right: Long-Term Solutions" },
        { id: "ai-coding", text: "5. The Problem with AI-Generated Code" },
        { id: "conclusion", text: "6. Conclusion" }
      ],
      content: `
        ...
        <h3 id="immediate-steps">3. Immediate Steps: What To Do First</h3>
        ...
        <h4 id="step-a" style="font-size: 18px; margin: 20px 0 10px 0;">A. Take the Application Offline</h4>
        ...
        <h4 id="step-b" style="font-size: 18px; margin: 20px 0 10px 0;">B. Rotate All Exposed Credentials</h4>
        ...
        <h4 id="step-c" style="font-size: 18px; margin: 20px 0 10px 0;">C. Remove Secrets from Git History</h4>
        ...
        <h4 id="step-d" style="font-size: 18px; margin: 20px 0 10px 0;">D. Notify Affected Users and the National Privacy Commission</h4>
        ...
        <h4 id="step-e" style="font-size: 18px; margin: 20px 0 10px 0;">E. Audit Access Logs</h4>
        ...
        <h3 id="rebuilding-right">4. Rebuilding It Right: Long-Term Solutions</h3>
        ...
        <h4 id="sol-a" style="font-size: 18px; margin: 20px 0 10px 0;">A. Enforce Authorization on Every Request</h4>
        ...
        <h4 id="sol-b" style="font-size: 18px; margin: 20px 0 10px 0;">B. Implement Role-Based Access Control (RBAC)</h4>
        ...
        <h4 id="sol-c" style="font-size: 18px; margin: 20px 0 10px 0;">C. Keep Secrets Outside the Codebase</h4>
        ...
        <h4 id="sol-d" style="font-size: 18px; margin: 20px 0 10px 0;">D. Enforce HTTPS</h4>
        ...
        <h4 id="sol-e" style="font-size: 18px; margin: 20px 0 10px 0;">E. Handle Errors Safely in Production</h4>
        ...
        <h4 id="sol-f" style="font-size: 18px; margin: 20px 0 10px 0;">F. Apply Data Minimization</h4>
        ...
        <h3 id="ai-coding">5. The Problem with AI-Generated Code</h3>
        ...
        <blockquote style="padding: 16px 24px; border-left: 4px solid var(--accent-coral); background: rgba(165,21,12,0.05); font-style: italic; margin: 20px 0; border-radius: 0 12px 12px 0;">
          AI tools are useful, but they should never be treated as a substitute for security awareness and code review.
        </blockquote>
        ...
        <p style="margin-top: 24px; font-size: 14px; color: var(--text-muted); border-top: 1px solid var(--border-light); padding-top: 16px;"><strong>References:</strong> Republic Act No. 10173 — Data Privacy Act of 2012 (Philippines); OWASP Top 10 (2021); OWASP Secure Design Principles; NIST Special Publication 800-53.</p>
      `
    }
  ]
};
