          ...
          <div class="blog-item-card featured-latest-card" onclick="window.location.href='blog-detail.html?id=${latest.id}'">
            ...
            <div class="featured-latest-body">
              <div class="featured-latest-badge-wrap">
                <span class="badge-category-subtle" style="display: inline-block; padding: 4px 12px; background: rgba(78, 104, 81, 0.14); color: var(--text-main); border-radius: 10px; font-size: 12px; font-weight: 700; border: 1px solid rgba(78, 104, 81, 0.3);">${latest.category}</span>
              </div>
              ...
              <div class="blog-item-card featured-card-responsive" onclick="window.location.href='blog-detail.html?id=${post.id}'" style="display: flex; flex-direction: column; padding: 0;">
                ...
                <div class="featured-card-body" style="padding: 24px; flex: 1; display: flex; flex-direction: column;">
                  <div style="margin-bottom: 10px;">
                    <span class="badge-category-subtle" style="display: inline-block; padding: 4px 12px; background: rgba(78, 104, 81, 0.14); color: var(--text-main); border-radius: 10px; font-size: 12px; font-weight: 700; border: 1px solid rgba(78, 104, 81, 0.3);">${post.category}</span>
                  </div>
