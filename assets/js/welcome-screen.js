 ...
 * Uses the official tsParticles background (particles-bg.js) for a 100% continuous, seamless background experience.
 */
...
(function () {
  ...
  function animateProgress(currentTime) {
    ...
    if (progress < 100) {
      ...
      // 3. Exit Transition: Scale down & fade out overlay smoothly, revealing homepage underneath
      setTimeout(() => {
